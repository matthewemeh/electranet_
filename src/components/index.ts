...
export { default as VoteBubble } from './VoteBubble';
...
export { default as DropdownInputMultiple } from './inputs/DropdownInputMultiple';
...
export { default as ResultTab } from './tabs/ResultTab';

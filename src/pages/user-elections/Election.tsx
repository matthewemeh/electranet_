    ...
    <main className='pb-10'>
      ...
      <div className='flex flex-col gap-10'>
        {Object.entries(groupedContestants).map(([partyID, contestants]) => (
          ...
          >
            <div
              className='-z-1 absolute right-0 opacity-50 w-70 h-70 top-10 rounded-full'
              style={{
      ...
      >
        {isGetFaceSuccess ? (
          <section className='text-center'>
            {isPermissionGranted ? (
              <TbFaceId className='w-10 h-10 mx-auto mb-2 box-content p-2 border text-primary-500 self-center bg-white rounded-lg' />
            ) : (
              <TbFaceIdError className='w-10 h-10 mx-auto mb-2 box-content p-2 border text-primary-500 self-center bg-white rounded-lg' />
            )}
            ...
            <div className='relative my-10 sm:my-5'>
              ...
              >
                <VideocamOff fontSize='large' className='text-primary-500 !w-15 !h-15' />
              ...
              <video muted autoPlay playsInline className='mx-auto w-60 h-60 sm:w-80 sm:h-70' />
            </div>
